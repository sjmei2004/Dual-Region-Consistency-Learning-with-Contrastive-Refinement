...
parser.add_argument('--model', type=str, default='2025-03-03-17-16-42EVIL8', help='model_name')
parser.add_argument('--gpu', type=str, default='0', help='GPU to use')
parser.add_argument('--normalization', type=str, default='batchnorm', help='normalization to use')
parser.add_argument('--epoch_num', type=int, default='2900', help='checkpoint to use')
...
snapshot_path = "../semi_model/PCC/" + FLAGS.model + "/"
...
def test_calculate_metric():
    ...
    save_mode_path = os.path.join(snapshot_path, 'PCC_best_model.pth')
